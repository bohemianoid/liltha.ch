...
abstract class BasePlace extends BaseObject implements Persistent
{
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PlacePeer::ADDRESS)) {
     ...
     * @return PropelObjectCollection|Lesson[] List of Lesson objects
     */
    public function getLessonsJoinDay($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LessonQuery::create(null, $criteria);
