 ...
 * @method PlaceQuery orderByAddress($order = Criteria::ASC) Order by the address column
 *
 * @method PlaceQuery groupByID() Group by the id column
 * @method PlaceQuery groupByName() Group by the name column
 * @method PlaceQuery groupByAddress() Group by the address column
 *
 ...
 *
 * @method PlaceQuery leftJoinLesson($relationAlias = null) Adds a LEFT JOIN clause to the query using the Lesson relation
 * @method PlaceQuery rightJoinLesson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Lesson relation
 * @method PlaceQuery innerJoinLesson($relationAlias = null) Adds a INNER JOIN clause to the query using the Lesson relation
 *
 ...
 * @method Place findOneByAddress(string $address) Return the first Place filtered by the address column
 *
 ...
 * @method array findByAddress(string $address) Return Place objects filtered by the address column
 *
...
abstract class BasePlaceQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'liltha', $modelName = 'Place', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `address` FROM `place` WHERE `id` = :p0';
        try {
    ...
    public function filterByAddress($address = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PlacePeer::ADDRESS, $address, $comparison);
    }
    ...
    public function filterByLesson($lesson, $comparison = null)
    {
        if ($lesson instanceof Lesson) {
            return $this
                ->addUsingAlias(PlacePeer::ID, $lesson->getPlaceID(), $comparison);
