...
/**
 * Base class that represents a query for the 'day' table.
 *
 *
 *
 * @method DayQuery orderByID($order = Criteria::ASC) Order by the id column
 * @method DayQuery orderByShorthand($order = Criteria::ASC) Order by the shorthand column
 * @method DayQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method DayQuery groupByID() Group by the id column
 * @method DayQuery groupByShorthand() Group by the shorthand column
 * @method DayQuery groupByName() Group by the name column
 *
 ...
 *
 * @method DayQuery leftJoinLesson($relationAlias = null) Adds a LEFT JOIN clause to the query using the Lesson relation
 * @method DayQuery rightJoinLesson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Lesson relation
 * @method DayQuery innerJoinLesson($relationAlias = null) Adds a INNER JOIN clause to the query using the Lesson relation
 *
 ...
 *
 * @method Day findOneByShorthand(string $shorthand) Return the first Day filtered by the shorthand column
 * @method Day findOneByName(string $name) Return the first Day filtered by the name column
 *
 * @method array findByID(int $id) Return Day objects filtered by the id column
 * @method array findByShorthand(string $shorthand) Return Day objects filtered by the shorthand column
 * @method array findByName(string $name) Return Day objects filtered by the name column
 *
...
abstract class BaseDayQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'liltha', $modelName = 'Day', $modelAlias = null)
    {
     ...
     *
     * @return   Day|Day[]|mixed the result, formatted by the current formatter
     */
    ...
    {
        $sql = 'SELECT `id`, `shorthand`, `name` FROM `day` WHERE `id` = :p0';
        try {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Day[]|mixed the list of results, formatted by the current formatter
     */
    ...
    /**
     * Filter the query on the shorthand column
     *
     * Example usage:
     * <code>
     * $query->filterByShorthand('fooValue');   // WHERE shorthand = 'fooValue'
     * $query->filterByShorthand('%fooValue%'); // WHERE shorthand LIKE '%fooValue%'
     * </code>
     *
     * @param     string $shorthand The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE)
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return DayQuery The current query, for fluid interface
     */
    public function filterByShorthand($shorthand = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($shorthand)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $shorthand)) {
                $shorthand = str_replace('*', '%', $shorthand);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(DayPeer::SHORTHAND, $shorthand, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DayPeer::NAME, $name, $comparison);
    }
    ...
    public function filterByLesson($lesson, $comparison = null)
    {
        if ($lesson instanceof Lesson) {
            return $this
                ->addUsingAlias(DayPeer::ID, $lesson->getDayID(), $comparison);
