...
/**
 * Base class that represents a row from the 'day' table.
 *
 *
 *
...
abstract class BaseDay extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the shorthand field.
     * @var        string
     */
    protected $shorthand;
    ...
    /**
     * Get the [shorthand] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [shorthand] column.
     *
     * @param string $v new value
     * @return Day The current object (for fluent API support)
     */
    public function setShorthand($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->shorthand !== $v) {
            $this->shorthand = $v;
            $this->modifiedColumns[] = DayPeer::SHORTHAND;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = DayPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->shorthand = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 3; // 3 = DayPeer::NUM_HYDRATE_COLUMNS.
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->lessonsScheduledForDeletion !== null) {
                if (!$this->lessonsScheduledForDeletion->isEmpty()) {
                    LessonQuery::create()
                        ->filterByPrimaryKeys($this->lessonsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DayPeer::SHORTHAND)) {
            $modifiedColumns[':p' . $index++]  = '`shorthand`';
        }
        if ($this->isColumnModified(DayPeer::NAME)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`shorthand`':
                        $stmt->bindValue($identifier, $this->shorthand, PDO::PARAM_STR);
                        break;
                    case '`name`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setShorthand($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DayPeer::SHORTHAND)) $criteria->add(DayPeer::SHORTHAND, $this->shorthand);
        if ($this->isColumnModified(DayPeer::NAME)) $criteria->add(DayPeer::NAME, $this->name);
    ...
    {
        $copyObj->setShorthand($this->getShorthand());
        ...
        if (null === $this->collLessons || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collLessons) {
                ...
                if (null !== $criteria) {
                    ...
                    $collLessons->getInternalIterator()->rewind();
                    return $collLessons;
                }
    ...
    {
        $lessonsToDelete = $this->getLessons(new Criteria(), $con)->diff($lessons);

        $this->lessonsScheduledForDeletion = unserialize(serialize($lessonsToDelete));

        foreach ($lessonsToDelete as $lessonRemoved) {
            $lessonRemoved->setDay(null);
        }
    ...
    public function removeLesson($lesson)
    {
        if ($this->getLessons()->contains($lesson)) {
            ...
            $this->lessonsScheduledForDeletion[]= clone $lesson;
            $lesson->setDay(null);
        }
     ...
     * been saved, it will retrieve related Lessons from storage.
     *
     ...
     * @return PropelObjectCollection|Lesson[] List of Lesson objects
     */
    public function getLessonsJoinCourse($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LessonQuery::create(null, $criteria);
        $query->joinWith('Course', $join_behavior);

        return $this->getLessons($query, $con);
    }
     ...
     * @return PropelObjectCollection|Lesson[] List of Lesson objects
     */
    public function getLessonsJoinPlace($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LessonQuery::create(null, $criteria);
